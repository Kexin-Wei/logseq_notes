- Web application penetration testing methodology based on [[OWASP Top 10]].
- ## Testability Overview
	- | Category | Testable | Notes |
	  |----------|----------|-------|
	  | A01: BAC | ✅ Yes | IDOR, privilege escalation, SSRF, access bypass |
	  ...
	  | A04: Cryptographic | ✅ Yes | TLS, certs, weak algorithms, protocols |
	  | A05: Injection | ✅ Yes | SQLi, XSS, command injection |
	  | A06: Insecure Design | ❌ No | Requires design/threat model review |
	  | A07: Authentication | ✅ Yes | Brute force, sessions, MFA bypass |
