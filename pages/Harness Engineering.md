...
collapsed:: true
	...
	- #### Operations
		...
		- Human Role
			...
			- ~90% automation, 10% senior judgment
			- operator owns spec accuracy
			- when something fails, the fix is almost never "try harder" — ask "what capability is missing?"
			- > [Ralph] best suited for greenfield projects, not legacy codebases
			- > [OpenAI] agents produce everything: code, tests, CI config, release tooling, internal dev tools, docs, design history, evaluation harnesses, review comments, repo management scripts, production dashboard definitions
		- Evolving Harnesses
